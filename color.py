class color(object):
  ...
  def __init__(self, rgb):
    if type(rgb) == type([0]):
      ...
      self.g = rgb[1]
      self.b = rgb[2]
    elif type(rgb) == type("HEX"):
      self.r,self.g,self.b = int(rgb[0:2],16),int(rgb[2:4],16),int(rgb[4:6],16)
    else:
      self.r,self.g,self.b = 0,0,0
      print "Probably an error."
  def rgb(self,spec="rgb"):
    if spec == "r":
      return self.r
    if spec == "g":
      return self.g
